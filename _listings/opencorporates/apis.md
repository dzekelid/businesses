...
- name: OpenCorporates Companies  Jurisdiction Code  Company Number Network
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/businesses/master/_listings/opencorporates/companies-jurisdiction-code-company-number-network-get.md
x-common:
- type: x-base
